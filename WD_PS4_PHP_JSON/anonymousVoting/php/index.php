            ...
            <section class="voting">
                ...
                <div class="form">
                    <form action="toDo.php" method="post">
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb0" value="Arryn" name="Arryn" onchange='this.form.submit()'">
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox"  id="rBlock_cb1" value="Baratheon" name="Baratheon" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb2" value="Greyjoy" name="Greyjoy" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb3" value="Lannister" name="Lannister" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb4" value="Martell" name="Martell" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb5" value="Stark" name="Stark" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb6" value="Targaryen" name="Targaryen" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb7" value="Tully" name="Tully" onchange='this.form.submit()'>
                        ...
                        <div class="rBlock_cb">
                            <input type="checkbox" id="rBlock_cb8" value="Tyrell" name="Tyrell" onchange='this.form.submit()'>
